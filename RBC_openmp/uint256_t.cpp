/*
Description: This is an unsigned integer 256 bit class adapted for the RBC scheme.
             This class is to be used along side the uint256_iter class for iterating
             across a keyspace. 

Convention:  Data is stored as an array of 8 unsigned 32 bit integers.
             Data is interpreted in a 'little-endian' manner so 
             that the least significant byte is stored first.
*/
